...
from Legacy.StockMaster import bulbea as bb
# imports - third-party packages
import pandas as pd
import quandl
from Legacy.StockMaster.bulbea import (
    _check_type,
    _check_str,
    _check_int,
...
# module imports
from Legacy.StockMaster.bulbea import Entity

from Legacy.bulbea._util.const import (
...
class Share(Entity):
    ...
    def __init__(self, source, ticker, start = None, end = None, latest = None, cache = False):
        ...
        quandl.ApiConfig.api_key = "_g8gXw5PfzHhtAC3wRut"

        #if not _check_environment_variable_set(envvar):
        #    msg = "Environment variable {envvar} for Quandl hasn't been set. A maximum of {max_calls} calls per day can be made. Visit {url} to get your API key."
